function DistancesCalculator(configuration, systemsBuilder, conversationReport, maxDescriptionMessageLengthCalculator) {
    ...
    function usingDefaultDistanceAsLastLegCalculateDistanceFromFirstSystemToSystem(nameOfTheSystemToAnalyse) {
        ...
        console.log(
            "Distance to " + nameOfTheSystemToAnalyse + " using default distance as last leg = " + value +
    ...
    this.leftUpperCornerDistanceBetweenFirstSystemAndSystem = function (nameOfTheSystemToAnalyse) {
        ...
        console.log("calculating distance to " + nameOfTheSystemToAnalyse)
        ...
        console.log("Analysing all systems location before " + nameOfTheSystemToAnalyse + " -> [" + nameOfTheSystemsBefore(nameOfTheSystemToAnalyse).join(", ") + "] using description length")
        ...
        nameOfTheSystemsBefore(nameOfTheSystemToAnalyse).forEach(function (aPreviousSystemName) {
            ...
            console.log(
                ...
                " + max description length between " + firstSystemBuilder.name() + "-" + nameOfTheSystemToAnalyse + " = " + maxDescriptionLengthDistance +
